...
zombieAttack.Zombie = function(state, x, y, data) {
...
zombieAttack.Zombie.prototype = Object.create(Phaser.Sprite.prototype);
zombieAttack.Zombie.prototype.constructor = zombieAttack.Zombie;

zombieAttack.Zombie.prototype.reset = function(x, y, data) {
  ...
  if(data.animationFrames) {
    this.animationName = data.asset + 'Animation';
...
zombieAttack.Zombie.prototype.damage = function (amount){
